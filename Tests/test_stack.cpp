...
void test_stack(void)
{
	...
	std::stack<float, std::vector<float> > STL2(std::vector<float>(1, 420.69));
	std::string name_STL2 = "STL2";
	ft::stack<float, ft::vector<float> > FTL2(ft::vector<float>(1, 420.69));
	std::string name_FTL2 = "FTL2";
	std::cout << "Constructor with vector<float>(1, 420.69) for STL2, FTL2." << std::endl;
