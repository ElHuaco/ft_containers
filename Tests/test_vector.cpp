...
/*   Updated: 2021/05/17 10:57:28 by alejandro        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	my::print(FTV5, name_FTV5);
//std::cout << std::endl;
//	std::cout << "STV5.push_front(69): ";
//	STV5.push_front(69);
//	my::print(STV5, name_STV5);
//	std::cout << "FTV5.push_front(69): ";
//	FTV5.push_front(69);
//	my::print(FTV5, name_FTV5);
//	std::cout << "STV5.pop_front(): ";
//	STV5.pop_front();
//	my::print(STV5, name_STV5);
//	std::cout << "FTV5.pop_front(): ";
//	FTV5.pop_front();
//	my::print(FTV5, name_FTV5);
...
//	my::print(FTV5, name_FTV5);
//std::cout << std::endl;
//	std::cout << "STV1.resize(8): ";
//	STV1.resize(8);
//	my::print(STV1, name_STV1);
//	std::cout << "STV5.resize(3): ";
//	STV5.resize(3);
//	my::print(STV5, name_STV5);
//	std::cout << "FTV1.resize(8): ";
//	FTV1.resize(8);
//	my::print(FTV1, name_FTV1);
//	std::cout << "FTV5.resize(3): ";
//	FTV5.resize(3);
//	my::print(FTV5, name_FTV5);
//std::cout << std::endl;
//std::cout << Color::yellow << "Operation Member Functions" << Color::clean << std::endl;
//	std::cout << "FTV1.splice(++FTV1.begin(), FTV5): ";
//	FTV1.splice(++FTV1.begin(), FTV5);
//	my::print(FTV1, name_FTV1);
//	my::print(FTV5, name_FTV5);
//	std::cout << "STV1.splice(++STV1.begin(), STV5): ";
//	STV1.splice(++STV1.begin(), STV5);
//	my::print(STV1, name_STV1);
//	my::print(STV5, name_STV5);
//std::cout << std::endl;
//	std::cout << "STV1.remove(0): ";
//	STV1.remove(0);
//	my::print(STV1, name_STV1);
//	std::cout << "FTV1.remove(0): ";
//	FTV1.remove(0);
//	my::print(FTV1, name_FTV1);
//	std::cout << "STV1.remove_if(is_bigger_than_99): ";
//	STV1.remove_if(is_bigger_than_99);
//	my::print(STV1, name_STV1);
//	std::cout << "FTV1.remove(is_bigger_than_99): ";
//	FTV1.remove_if(is_bigger_than_99);
//	my::print(FTV1, name_FTV1);
//std::cout << std::endl;
//	FTV1.push_back(78);
//	FTV1.push_back(91);
...
//	STV1.push_back(456);
//my::print(STV1, name_STV1);
//	std::cout << "STV1.unique(): ";
//	STV1.unique();
//	my::print(STV1, name_STV1);
//	std::cout << "FTV1.unique(): ";
//	FTV1.unique();
//	my::print(FTV1, name_FTV1);
//std::cout << std::endl;
//	STV1.push_back(666);
...
//	FTV1.push_back(666);
//	my::print(FTV1, name_FTV1);
//	std::cout << "STV1.unique(both_even): ";
//	STV1.unique(both_even);
//	my::print(STV1, name_STV1);
//	std::cout << "FTV1.unique(both_even): ";
//	FTV1.unique(both_even);
//	my::print(FTV1, name_FTV1);
//std::cout << std::endl;
//	std::cout << "STV1.sort(): ";
//	STV1.sort();
...
//	my::print(FTV1, name_FTV1);
//std::cout << std::endl;
//	std::cout << "STV1.merge(STV2): ";
//	STV1.merge(STV2);
//	my::print(STV1, name_STV1);
//	std::cout << "FTV1.merge(FTV2): ";
//	FTV1.merge(FTV2);
//	my::print(FTV1, name_FTV1);
//std::cout << std::endl;
//	std::cout << "STV1.reverse(): ";
//	STV1.reverse();
//	my::print(STV1, name_STV1);
//	std::cout << "FTV1.reverse(): ";
//	FTV1.reverse();
//	my::print(FTV1, name_FTV1);
//
